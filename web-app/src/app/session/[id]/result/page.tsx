...
export default function ResultPage() {
  ...
  if (loading) return (
    <main className="min-h-screen bg-[#f5ede0] flex items-center justify-center">
      <div className="text-center space-y-3">
        ...
        <p className="text-[#a08060] text-sm">計算結果中…</p>
      </div>
    </main>
  )
  ...
  return (
    <main className="min-h-screen bg-[#f5ede0] flex flex-col">
      <div className="bg-[#3d2424] px-6 pt-12 pb-10 rounded-b-[2rem]">
        <div className="max-w-sm mx-auto text-center">
          <div className="w-16 h-16 bg-[#cda368]/20 rounded-full flex items-center justify-center mx-auto mb-3">
            <svg className="w-8 h-8 text-[#cda368]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
            </svg>
          </div>
          <p className="text-[#a08060] text-xs uppercase tracking-widest mb-1">今天就吃這個</p>
          {displayName && (
            ...
            {results.length > 1 && (
              <div className="bg-white rounded-2xl border border-[#e8d8c0] overflow-hidden">
                <div className="px-4 pt-4 pb-1">
                  <p className="text-xs font-semibold text-[#a08060] uppercase tracking-wider">完整排名</p>
                </div>
        ...
        {displayName && (
          <div className="space-y-3 pt-1">
            <button
              ...
              className="w-full bg-white hover:bg-[#f5ede0] text-[#3d2424] font-semibold py-3.5 rounded-2xl text-sm border border-[#e8d8c0] transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={() => router.push('/')}
              className="w-full text-[#a08060] hover:text-[#3d2424] font-medium py-3 text-sm transition-colors"
            >
              回首頁，再玩一次
            </button>
          </div>
